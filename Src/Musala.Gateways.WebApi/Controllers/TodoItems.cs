using Musala.Gateways.Application.Features.TodoItems.Commands.CreateTodoItem;
using Musala.Gateways.Application.Features.TodoItems.Commands.DeleteTodoItem;
using Musala.Gateways.Application.Features.TodoItems.Commands.UpdateTodoItem;
using Musala.Gateways.Application.Features.TodoItems.Queries.GetAllTodoItems;
using Musala.Gateways.Application.Features.TodoItems.Queries.GetTodoItem;
...
{
    [Route("ns-gateways/api/todos/{todoId}/[controller]")]
    [ApiController]
